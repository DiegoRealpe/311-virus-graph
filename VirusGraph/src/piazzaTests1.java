...
public class piazzaTests1 {
    ...
    public void addCommunication() {
        ...
        assertEquals(0, monitor.getLedger().size());

        // Insert a tuple
        monitor.addCommunication(1, 2, 3);
        assertEquals(1, monitor.getLedger().size());
    ...
    public void createGraphExampleOne() {
        ...
        List<Connection> commList =
                monitor.getLedger();
        assertEquals(4, commList.get(0).getTimestamp());
        assertEquals(8, commList.get(1).getTimestamp());
        assertEquals(8, commList.get(2).getTimestamp());
        assertEquals(12, commList.get(3).getTimestamp());
