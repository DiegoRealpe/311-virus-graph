...
public class piazzaTests2 {
	
	CommunicationsMonitor cm;
	ArrayList<Connection> communications;
	...
	public void before() {
		...
		communications = (ArrayList<Connection>) cm.getLedger();
	}
	...
	public void testAddCommunication() {
		...
		assertEquals(1, communications.get(0).getIDA());
		assertEquals(2, communications.get(1).getIDA());
		assertEquals(3, communications.get(2).getIDA());
		assertEquals(1, communications.get(3).getIDA());
		
		assertEquals(2, communications.get(0).getIDB());
		assertEquals(4, communications.get(1).getIDB());
		assertEquals(4, communications.get(2).getIDB());
		assertEquals(4, communications.get(3).getIDB());
	...
	public void testAddAfterGraph() {
		...
		assertEquals(4, cm.getLedger().size());
	}
